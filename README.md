...
* [2.1.0](https://hub.docker.com/r/11notes/patchmon/tags?name=2.1.0)
* [2.1.0-unraid](https://hub.docker.com/r/11notes/patchmon/tags?name=2.1.0-unraid)
* [2.1.0-nobody](https://hub.docker.com/r/11notes/patchmon/tags?name=2.1.0-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/patchmon:2.1.0
docker pull ghcr.io/11notes/patchmon:2.1.0
docker pull quay.io/11notes/patchmon:2.1.0
```
...
*created 15.08.2026, 06:08:25 (CET)*